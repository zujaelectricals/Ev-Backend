...
# CORS Settings
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:8000,http://192.168.1.40:8080,http://192.168.1.40:8000,http://192.168.1.40,http://192.168.1.44:8080,http://localhost:8080', cast=lambda v: [s.strip() for s in v.split(',')])
...
RAZORPAY_PAYOUT_WEBHOOK_SECRET = config('RAZORPAY_PAYOUT_WEBHOOK_SECRET', default='')
